...
export default function AllStudentNB40() {
  ...
  const sampleStudentData = [
    ...
    {
      id: 2,
      student_name: "Siti Aminah binti Mohd",
      matric_no: "MY5678",
    },
    {
      id: 3,
      student_name: "Muhammad Tan Wei",
      matric_no: "MY9012",
    },
    {
      id: 4,
      student_name: "Nur Hidayah Mohd Yusof",
      matric_no: "MY3456",
    },
    {
      id: 5,
      student_name: "Kamalraj a/l Ramasamy",
      matric_no: "MY7890",
    },
    {
      id: 6,
      student_name: "Priya d/o Rajendran",
      matric_no: "MY2345",
    },
                  ...
                  <tr key={i} className="text-gray-500">
                    ...
                    <td className="pb-6">
                      <button
                        ...
                        onClick={() =>
                          navigate(
                            "/transactions/details/student/studentNB40Details"
                          )
                        }
