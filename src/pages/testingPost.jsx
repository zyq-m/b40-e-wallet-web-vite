  ...
  const handleSubmit = async (event) => {
    ...
    return (
      ...
      //   </Layout>
        <Layout>
        <div className="p-9 rounded-2xl shadow-md bg-white w-[35rem]">
      <h1 className="mb-8 text-3xl font-bold text-center">Register Student</h1>
      <form onSubmit={handleSubmit}>
        <div className="items-center">
          <input
            type="text"
          ...
          <input
            ...
            onChange={handleChange}
          />
          <label htmlFor="b40" className="ml-2">B40 Student?(Tick if yes)</label>
        </div>
        <div className="flex flex-col items-center">
          <button
            type="submit"
      ...
      {apiResponse && (
        <div className="mt-4">
          ...
          {apiResponse instanceof Error ? (
            ...
            // <div className="text-green-500">Cafe registered successfully!</div>
            //Student
            <div className="text-green-500">Student registered successfully!</div>
          )}
        </div>
      )}
    </div>
